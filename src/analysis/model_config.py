...
MODEL_LIMITS: Dict[str, ModelLimits] = {
    ...
    "gpt-3.5-turbo": ModelLimits(200000, 500, 10000, 2000000, supports_batch=True),
    "gpt-3.5-turbo-0125": ModelLimits(200000, 500, 10000, 2000000, supports_batch=True),
    "gpt-3.5-turbo-1106": ModelLimits(200000, 500, 10000, 2000000, supports_batch=True),
    "gpt-3.5-turbo-16k": ModelLimits(200000, 500, 10000, 2000000, supports_batch=True),
    "gpt-3.5-turbo-instruct": ModelLimits(90000, 3500, 200000, 0, supports_batch=True),
    "gpt-3.5-turbo-instruct-0914": ModelLimits(90000, 3500, 200000, 0, supports_batch=True),
    
    # GPT-4 models
    "gpt-4": ModelLimits(10000, 500, 10000, 100000),
    "gpt-4-0613": ModelLimits(10000, 500, 10000, 100000),
    "gpt-4-turbo": ModelLimits(30000, 500, 90000, 0),
    "gpt-4-turbo-2024-04-09": ModelLimits(30000, 500, 90000, 0),
    "gpt-4-turbo-preview": ModelLimits(30000, 500, 90000, 0),
    "gpt-4-0125-preview": ModelLimits(30000, 500, 90000, 0),
    "gpt-4-1106-preview": ModelLimits(30000, 500, 90000, 0),
    
    # GPT-4.1 models
    "gpt-4.1-2025-04-14": ModelLimits(30000, 500, 900000, 0),
    "gpt-4.1": ModelLimits(30000, 500, 900000, 0),
    "gpt-4.1-long-context": ModelLimits(200000, 100, 2000000, 0, supports_flex=True),
    "gpt-4.1-mini": ModelLimits(200000, 500, 2000000, 0, supports_batch=True),
    "gpt-4.1-mini-2025-04-14": ModelLimits(200000, 500, 2000000, 0, supports_batch=True),
    "gpt-4.1-mini-long-context": ModelLimits(400000, 200, 4000000, 0, supports_flex=True),
    "gpt-4.1-nano": ModelLimits(200000, 500, 2000000, 0, supports_batch=True),
    "gpt-4.1-nano-2025-04-14": ModelLimits(200000, 500, 2000000, 0, supports_batch=True),
    "gpt-4.1-nano-long-context": ModelLimits(400000, 200, 4000000, 0, supports_flex=True),
    
    # GPT-4o models
    "gpt-4o": ModelLimits(30000, 500, 90000, 0),
    "gpt-4o-2024-05-13": ModelLimits(30000, 500, 90000, 0),
    "gpt-4o-2024-08-06": ModelLimits(30000, 500, 90000, 0),
    "gpt-4o-2024-11-20": ModelLimits(30000, 500, 90000, 0),
    "gpt-4o-audio-preview": ModelLimits(30000, 500, 90000, 0),
    "gpt-4o-audio-preview-2024-10-01": ModelLimits(30000, 500, 90000, 0),
    "gpt-4o-audio-preview-2024-12-17": ModelLimits(30000, 500, 90000, 0),
    "gpt-4o-audio-preview-2025-06-03": ModelLimits(250000, 3000, 0, 0),
    "gpt-4o-mini": ModelLimits(200000, 500, 10000, 2000000, supports_batch=True),
    "gpt-4o-mini-2024-07-18": ModelLimits(200000, 500, 10000, 2000000, supports_batch=True),
    "gpt-4o-mini-audio-preview": ModelLimits(200000, 500, 10000, 2000000, supports_batch=True),
    "gpt-4o-mini-audio-preview-2024-12-17": ModelLimits(200000, 500, 10000, 2000000, supports_batch=True),
    "gpt-4o-mini-search-preview": ModelLimits(6000, 100, 0, 0),
    "gpt-4o-mini-search-preview-2025-03-11": ModelLimits(6000, 100, 0, 0),
    "gpt-4o-mini-transcribe": ModelLimits(50000, 500, 0, 0),
    "gpt-4o-search-preview": ModelLimits(6000, 100, 0, 0),
    "gpt-4o-search-preview-2025-03-11": ModelLimits(6000, 100, 0, 0),
    "gpt-4o-transcribe": ModelLimits(10000, 500, 0, 0),
    
    # GPT-5 models
    "gpt-5": ModelLimits(500000, 500, 1500000, 0, supports_flex=True, is_reasoning_model=True),
    "gpt-5-2025-08-07": ModelLimits(500000, 500, 1500000, 0, supports_flex=True, is_reasoning_model=True),
    "gpt-5-chat-latest": ModelLimits(30000, 500, 900000, 0, is_reasoning_model=True),
    "gpt-5-codex": ModelLimits(500000, 500, 900000, 0, supports_flex=True, is_reasoning_model=True),
    "gpt-5-mini": ModelLimits(500000, 500, 5000000, 0, supports_batch=True, supports_flex=True, is_reasoning_model=True),
    "gpt-5-mini-2025-08-07": ModelLimits(500000, 500, 5000000, 0, supports_batch=True, supports_flex=True, is_reasoning_model=True),
    "gpt-5-nano": ModelLimits(200000, 500, 2000000, 0, supports_batch=True, is_reasoning_model=True),
    "gpt-5-nano-2025-08-07": ModelLimits(200000, 500, 2000000, 0, supports_batch=True, is_reasoning_model=True),
    
    # Other models
    "gpt-audio": ModelLimits(250000, 3000, 0, 0),
    "gpt-audio-2025-08-28": ModelLimits(250000, 3000, 0, 0),
    "chatgpt-4o-latest": ModelLimits(500000, 200, 0, 0),
    "o1": ModelLimits(30000, 500, 90000, 0, is_reasoning_model=True),
    "o1-2024-12-17": ModelLimits(30000, 500, 90000, 0, is_reasoning_model=True),
    "o1-mini": ModelLimits(200000, 500, 2000000, 0, supports_batch=True, is_reasoning_model=True),
    "o1-mini-2024-09-12": ModelLimits(200000, 500, 2000000, 0, supports_batch=True, is_reasoning_model=True),
    "o1-pro": ModelLimits(30000, 500, 90000, 0, is_reasoning_model=True),
    "o1-pro-2025-03-19": ModelLimits(30000, 500, 90000, 0, is_reasoning_model=True),
    "o3": ModelLimits(30000, 500, 90000, 0, is_reasoning_model=True),
    "o3-2025-04-16": ModelLimits(30000, 500, 90000, 0, is_reasoning_model=True),
    "o3-mini": ModelLimits(200000, 500, 2000000, 0, supports_batch=True, is_reasoning_model=True),
    "o3-mini-2025-01-31": ModelLimits(200000, 500, 2000000, 0, supports_batch=True, is_reasoning_model=True),
    "o4-mini": ModelLimits(200000, 500, 2000000, 0, supports_batch=True, is_reasoning_model=True),
    "o4-mini-2025-04-16": ModelLimits(200000, 500, 2000000, 0, supports_batch=True, is_reasoning_model=True),
    "o4-mini-deep-research": ModelLimits(200000, 500, 200000, 0, is_reasoning_model=True),
    "o4-mini-deep-research-2025-06-26": ModelLimits(250000, 3000, 0, 0, is_reasoning_model=True),
}
