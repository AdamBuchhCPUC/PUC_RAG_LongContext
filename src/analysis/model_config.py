...
MODEL_LIMITS: Dict[str, ModelLimits] = {
    ...
    "gpt-4o-2024-05-13": ModelLimits(450000, 5000, 0, 1350000),
    "gpt-4o-2024-08-06": ModelLimits(450000, 5000, 0, 1350000),
    "gpt-4o-2024-11-20": ModelLimits(450000, 5000, 0, 1350000),
    "gpt-4o-audio-preview": ModelLimits(450000, 5000, 0, 1350000),
    "gpt-4o-audio-preview-2024-10-01": ModelLimits(450000, 5000, 0, 1350000),
    "gpt-4o-audio-preview-2024-12-17": ModelLimits(450000, 5000, 0, 1350000),
    "gpt-4o-audio-preview-2025-06-03": ModelLimits(250000, 3000, 0, 0),
    "gpt-4o-mini": ModelLimits(2000000, 5000, 0, 20000000, supports_batch=True),
    "gpt-4o-mini-2024-07-18": ModelLimits(2000000, 5000, 0, 20000000, supports_batch=True),
    "gpt-4o-mini-audio-preview": ModelLimits(2000000, 5000, 0, 20000000, supports_batch=True),
    "gpt-4o-mini-audio-preview-2024-12-17": ModelLimits(2000000, 5000, 0, 20000000, supports_batch=True),
    "gpt-4o-mini-search-preview": ModelLimits(45000, 500, 0, 0),
    "gpt-4o-mini-search-preview-2025-03-11": ModelLimits(45000, 500, 0, 0),
    "gpt-4o-mini-transcribe": ModelLimits(150000, 2000, 0, 0),
    "gpt-4o-search-preview": ModelLimits(45000, 500, 0, 0),
    "gpt-4o-search-preview-2025-03-11": ModelLimits(45000, 500, 0, 0),
    "gpt-4o-transcribe": ModelLimits(100000, 2000, 0, 0),
    
    # GPT-5 models
    "gpt-5": ModelLimits(1000000, 5000, 0, 3000000, supports_flex=True, is_reasoning_model=True),
    "gpt-5-2025-08-07": ModelLimits(1000000, 5000, 0, 3000000, supports_flex=True, is_reasoning_model=True),
    "gpt-5-chat-latest": ModelLimits(450000, 5000, 0, 1350000, is_reasoning_model=True),
    "gpt-5-codex": ModelLimits(1000000, 5000, 0, 1350000, supports_flex=True, is_reasoning_model=True),
    "gpt-5-mini": ModelLimits(2000000, 5000, 0, 20000000, supports_batch=True, supports_flex=True, is_reasoning_model=True),
    "gpt-5-mini-2025-08-07": ModelLimits(2000000, 5000, 0, 20000000, supports_batch=True, supports_flex=True, is_reasoning_model=True),
    "gpt-5-nano": ModelLimits(2000000, 5000, 0, 20000000, supports_batch=True, is_reasoning_model=True),
    "gpt-5-nano-2025-08-07": ModelLimits(2000000, 5000, 0, 20000000, supports_batch=True, is_reasoning_model=True),
    "gpt-5-pro": ModelLimits(450000, 5000, 0, 1350000, is_reasoning_model=True),
    "gpt-5-pro-2025-10-06": ModelLimits(450000, 5000, 0, 1350000, is_reasoning_model=True),
    
    # Other models
    "gpt-audio": ModelLimits(250000, 3000, 0, 0),
    "gpt-audio-2025-08-28": ModelLimits(250000, 3000, 0, 0),
    "gpt-audio-mini": ModelLimits(250000, 3000, 0, 0),
    "gpt-audio-mini-2025-10-06": ModelLimits(250000, 3000, 0, 0),
